...
data <- tidyhydat::hy_daily_flows("08HB048") %>% add_date_variables()
...
flow_data <- add_cumulative_yield(station_number = "08HB048", basin_area = c("08HB048"=10.2))
...
flow_data <- calc_longterm_stats(station_number = c("08HB048","08NM116"))
flow_data <- calc_annual_stats(station_number = c("08HB048","08NM116"))
flow_data <- calc_all_annual_stats(station_number = c("08HB048","08NM116"))
flow_data <- calc_annual_cumulative_stats(station_number = c("08HB048","08NM116"))
flow_data <- calc_annual_flow_timing(station_number = c("08HB048","08NM116"))
flow_data <- calc_annual_lowflows(station_number = c("08HB048","08NM116"))
flow_data <- calc_annual_outside_normal(station_number = c("08HB048","08NM116"))
flow_data <- calc_daily_stats(station_number = c("08HB048","08NM116"))
flow_data <- calc_daily_cumulative_stats(station_number = c("08HB048","08NM116"))
flow_data <- calc_flow_percentile(station_number = c("08HB048","08NM116"), flow_value = 10000)
flow_data <- calc_lt_mad(station_number = c("08HB048","08NM116"))
flow_data <- calc_lt_percentile(station_number = c("08HB048","08NM116"), percentiles = 50)
flow_data <- calc_monthly_cumulative_stats(station_number = c("08HB048","08NM116"))
flow_data <- calc_monthly_stats(station_number = c("08HB048","08NM116"))
flow_data <- screen_flow_data(station_number = c("08HB048","08NM116"))
