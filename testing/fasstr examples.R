...
flow_data <- add_basin_area(data = "08HB048")
flow_data <- add_seasons(data = "08HB048")
...
flow_data <- calc_all_annual_stats(data = "08HB048")
flow_data <- calc_annual_cumulative_stats(data = "08HB048")
flow_data <- calc_annual_flow_timing(data = "08HB048")
flow_data <- calc_annual_lowflows(data = "08HB048")
flow_data <- calc_annual_outside_normal(data = "08HB048")
flow_data <- calc_daily_stats(data = "08HB048")
flow_data <- calc_daily_cumulative_stats(data = "08HB048")
flow_data <- calc_flow_percentile(data = "08HB048")
flow_data <- calc_lt_mad(data = "08HB048")
flow_data <- calc_lt_percentile(data = "08HB048")
flow_data <- calc_monthly_cumulative_stats(data = "08HB048")
flow_data <- calc_monthly_stats(data = "08HB048")
flow_data <- screen_flow_data(data = "08HB048")
...
plot_missing_dates(data = "08HB048")
plot_monthly_cumulative_stats(data = "08HB048")
plot_monthly_stats(data = "08HB048")
plot_annual_cumulative_stats(data = "08HB048")
...
flow_data <- calc_annual_lowflows(data = c("08HB048","08NM116"))
flow_data <- calc_annual_outside_normal(data = c("08HB048","08NM116"))
flow_data <- calc_daily_stats(data = c("08HB048","08NM116"))
flow_data <- calc_daily_cumulative_stats(data = c("08HB048","08NM116"))
flow_data <- calc_flow_percentile(data = c("08HB048","08NM116"))
flow_data <- calc_lt_mad(data = c("08HB048","08NM116"))
flow_data <- calc_lt_percentile(data = c("08HB048","08NM116"))
flow_data <- calc_monthly_cumulative_stats(data = c("08HB048","08NM116"))
flow_data <- calc_monthly_stats(data = c("08HB048","08NM116"))
flow_data <- screen_flow_data(data = c("08HB048","08NM116"))
plot_flow_data(data = c("08HB048","08NM116"))
plot_annual_cumulative_stats(data = c("08HB048","08NM116"))
plot_annual_flow_timing(data = c("08HB048","08NM116"))
plot_annual_outside_normal(data = c("08HB048","08NM116"))
plot_annual_stats(data = c("08HB048","08NM116"))
#plot_annual_trends(data = c("08HB048","08NM116"))
plot_daily_cumulative_stats(data = c("08HB048","08NM116"))
plot_daily_stats(data = c("08HB048","08NM116"))
plot_data_screening(data = c("08HB048","08NM116"))
plot_flow_duration(data = c("08HB048","08NM116"))
plot_longterm_stats(data = c("08HB048","08NM116"))
plot_missing_dates(data = c("08HB048","08NM116"))
plot_monthly_cumulative_stats(data = c("08HB048","08NM116"))
plot_monthly_stats(data = c("08HB048","08NM116"))
plot_annual_cumulative_stats(data = c("08HB048","08NM116"))
