...
#' \dontrun{
#' 
#'compute_annual_trends(flowdata = flowdata, station_name = "MissionCreek", write_table = TRUE)
#' 
#'compute_annual_trends(HYDAT = "08NM116", water_year = TRUE, water_year_start = 8)
#'
#' }
#' @export
...
compute_annual_trends <- function(flowdata=NULL,
                                  HYDAT=NULL,
                                  trendsdata=NULL,
                                  zyp_method=NA,
                                  basin_area=NA, 
