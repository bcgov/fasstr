...
#'    calculated from fasstr_annual_lowflows() function.
#'
...
#' \dontrun{
#' 
#'fasstr_annual_lowflows_plots(flowdata = flowdata, station_name = "MissionCreek", write_table = TRUE)
#' 
#'fasstr_annual_lowflows_plots(HYDAT = "08NM116", water_year = TRUE, water_year_start = 8, rolling_days = c(3,7))
#'
#' }
#' @export
