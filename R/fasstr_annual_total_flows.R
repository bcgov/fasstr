...
#'    the statistics from all daily discharge values from all years, unless specified.
#'
...
#' \dontrun{
#' 
#'fasstr_annual_total_flows(flowdata = flowdata, station_name = "MissionCreek", write_table = TRUE)
#' 
#'fasstr_annual_total_flows(HYDAT = "08NM116", water_year = TRUE, water_year_start = 8)
#'
#' }
#' @export

#--------------------------------------------------------------
fasstr_annual_total_flows <- function(flowdata=NULL,
                                      HYDAT=NULL,
                                      basin_area=NA,
                                      water_year=FALSE,
                                      water_year_start=10,
  ...
  if( is.na(basin_area) )  {
    warning("no basin_area provided, values will be NA")}
