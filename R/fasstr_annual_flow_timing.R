...
#' \dontrun{
#' 
#'fasstr_annual_flow_timing(flowdata = flowdata, station_name = "MissionCreek", write_table = TRUE)
#' 
#'fasstr_annual_flow_timing(HYDAT = "08NM116", water_year = TRUE, water_year_start = 8, percent_total = 50)
#'
#' }
#' @export
