...
#' \dontrun{
#' 
#'screen_flow_data(flowdata = flowdata, station_name = "MissionCreek", write_table = TRUE)
#' 
#'screen_flow_data(HYDAT = "08NM116", water_year = TRUE, water_year_start = 8)
#'
#' }
#' @export
...
screen_flow_data <- function(flowdata=NULL,
                             HYDAT=NULL,
                             rolling_days=1,
                             rolling_align="right",
                             water_year=FALSE,
