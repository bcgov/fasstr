...
#' \dontrun{
#' 
#' calc_percentile_rank(flowdata = data, start_year = 1980, end_year = 2010)
#' 
#' calc_percentile_rank(HYDAT = "08NM116",water_year = TRUE, exclude_years = (1990, 1992:1994))
#' 
#' calc_percentile_rank(HYDAT = "08NM116", percent_MAD = 20)
#' 
#' }
#' @export
...
calc_percentile_rank <- function(flowdata=NULL,
                                   HYDAT=NULL,
                                   flowvalue=NA,
                                   water_year=FALSE, 
                                   water_year_start=10,
