...
#' \dontrun{
#' 
#' fasstr_LT_Percentile(flowdata = data, start_year = 1980, end_year = 2010, percentile = 90)
#' 
#' fasstr_LT_Percentile(HYDAT = "08NM116", percentile = 20)
#' 
#' }
#' @export
...
fasstr_LT_Percentile <- function(flowdata=NULL,
                                 HYDAT=NULL,
                                 percentiles=NA,
                                 water_year=FALSE, 
                                 water_year_start=10,
