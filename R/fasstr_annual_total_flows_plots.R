...
#' \dontrun{
#' 
#'fasstr_annual_total_flows_plots(flowdata = flowdata, station_name = "MissionCreek", write_table = TRUE)
#' 
#'fasstr_annual_total_flows_plots(HYDAT = "08NM116", water_year = TRUE, water_year_start = 8)
#'
#' }
#' @export
