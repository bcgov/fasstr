...
#' \dontrun{
#' 
#'plot_annual_stats(flowdata = flowdata, station_name = "MissionCreek", write_table = TRUE)
#' 
...
plot_annual_stats <- function(flowdata=NULL,
                                      HYDAT=NULL, 
                                      percentiles=NA,
                                      water_year=FALSE, 
                                      water_year_start=10,
  ...
  annual_stats <- fasstr::calc_annual_stats(flowdata=flowdata,
                                              HYDAT=HYDAT,
