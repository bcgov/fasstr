...
#' \dontrun{
#' 
#'fasstr_annual_trends_plots(flowdata = flowdata, station_name = "MissionCreek", write_table = TRUE)
#' 
#'fasstr_annual_trends_plots(HYDAT = "08NM116", water_year = TRUE, water_year_start = 8)
#'
#' }
#' @export
...
fasstr_annual_trends_plots <- function(flowdata=NULL,
  ...
  trends_results <- fasstr::fasstr_annual_trends_analysis(flowdata=NULL,
                                                          HYDAT=NULL,
