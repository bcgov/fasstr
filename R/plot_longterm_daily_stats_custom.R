...
#'    years, unless specified. Data calculated using calc_longterm_daily_stats() function.
#'
...
#' plot_longterm_daily_stats_custom(data = flow_data,
#'                             start_year = 1980)
#' 
#' # Plot statistics using station_number argument with defaults
#' plot_longterm_daily_stats_custom(station_number = "08NM116",
#'                             start_year = 1980)
#' 
...
plot_longterm_daily_stats_custom <- function(data,
                                               dates = Date,
                                               values = Value,
