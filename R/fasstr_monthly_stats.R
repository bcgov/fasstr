...
#' \dontrun{
#' 
#'fasstr_monthly_stats(flowdata = flowdata, station_name = "MissionCreek", write_table = TRUE)
#' 
#'fasstr_monthly_stats(HYDAT = "08NM116", water_year = TRUE, water_year_start = 8, percentiles = c(1:10))
#'
#'fasstr_monthly_stats(HYDAT = "08NM116", months = 7:9)
#'
#' }
#' @export
