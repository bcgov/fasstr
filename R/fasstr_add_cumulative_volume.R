...
#' 
#' @return A column of cumulative volumetric flows for each day for each year specific called 'Cumul_Volume' added to the flowdata 
#'    data frame input or HYDAT dataset, in units of cubic metres.
#'
#' @examples
#' \dontrun{
#' 
#'fasstr_add_cumulative_volume(flowdata = flowdata)
#' 
#'fasstr_add_cumulative_volume(HYDAT = "08NM116", water_year = TRUE, water_year_start = 8)
#'
#' }
#' @export
