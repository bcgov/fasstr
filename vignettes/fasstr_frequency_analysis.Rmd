...
2) **compute_frequency_quantile()** - conduct an annual frequency analysis from daily streamflow data and output a specific quantile based on a duration (rolling days) and return period (analysis calculates minimums/maximums and subsequently ranks that data).
...
4) **compute_frequency_analysis()** - conduct a general frequency analysis with custom data (analysis ranks data provided; used within each of the previous functions).
