...
One of the strengths of fasstr is the ability to customize how data is filtered and analyzed within functions, thereby minimizing the lines of code in your scripting. Described here are some of the options available to the functions of this package. Not all functions have all these options so please see the documentation for each function to see which argument options are available (ex. `?calc_annual_stats`).
...
# This calculates the annual 7-day rolling mean statistics 
# with align left (see add_rolling_days() above)
calc_annual_stats(station_number = "08NM116", 
                  start_year = 1980, 
                  end_year = 2010,
                  roll_days = 7,
