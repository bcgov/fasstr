...
output: pdf_document #pdf_document rmarkdown::html_vignette word_document
vignette: >
...
```{r, eval=TRUE, warning=FALSE, message=FALSE, fig.height = 2.5, fig.width = 7}
...
```{r, eval=TRUE, warning=FALSE, message=FALSE, fig.height = 3, fig.width = 7}
plot_data_screening(station_number = "08NM116") 
```

```{r, eval=TRUE, warning=FALSE, message=FALSE, fig.height = 4, fig.width = 7}
...
Can also include a year using the argument
```{r, eval=TRUE, warning=FALSE, message=FALSE, fig.height = 2.5, fig.width = 7}
plot_daily_stats(station_number = "08NM116", start_year = 1974,
                 include_year = 2000) 
```
...
```{r, eval=TRUE, warning=FALSE, message=FALSE, fig.height = 4.5, fig.width = 7}
