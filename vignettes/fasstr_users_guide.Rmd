...
```{r,  warning=FALSE, message=FALSE, fig.height = 2.5, fig.width = 7}
...
```{r,  warning=FALSE, message=FALSE}
calc_longterm_stats(station_number = "08NM116", start_year = 1974)
```
...
```{r,  warning=FALSE, message=FALSE, fig.height = 2.5, fig.width = 7}
plot_longterm_stats(station_number = "08NM116", start_year = 1974) 
```
...
```{r,  warning=FALSE, message=FALSE, fig.height = 2.5, fig.width = 7}
plot_annual_stats(station_number = "08NM116", start_year = 1974) 
```
...
For example, the annual provide the total annual and seasonal (optional) flows, and the monthly and daily period cumulate for each month or day until the end of the year
```{r,  warning=FALSE, message=FALSE}
...
```{r,  warning=FALSE, message=FALSE, fig.height = 3, fig.width = 7}
plot_annual_cumulative_stats(station_number = "08NM116", start_year = 1974) 
```
...
```{r,  warning=FALSE, message=FALSE}
calc_monthly_cumulative_stats(station_number = "08NM116", start_year = 1974)
```

```{r,  warning=FALSE, message=FALSE, fig.height = 3, fig.width = 7}
plot_monthly_cumulative_stats(station_number = "08NM116", start_year = 1974) 
```
...
```{r,  warning=FALSE, message=FALSE, fig.height = 3, fig.width = 7}
plot_daily_cumulative_stats(station_number = "08NM116", start_year = 1974, use_yield = TRUE) 
```
...
calc_lt_mad(station_number = "08NM116", start_year = 1974,
...
```{r,  echo=TRUE, warning=FALSE, message=FALSE}
calc_lt_percentile(station_number = "08NM116", start_year = 1974,
...
```{r,  echo=TRUE, warning=FALSE, message=FALSE}
calc_flow_percentile(station_number = "08NM116", start_year = 1974,
                     flow_value = 6.270)
```
...
```{r,  warning=FALSE, message=FALSE}
calc_annual_lowflows(station_number = "08NM116", start_year = 1974)
```



```{r,  warning=FALSE, message=FALSE, fig.height = 4.5, fig.width = 7}
plot_annual_lowflows(station_number = "08NM116", start_year = 1974) 
```
...
```{r,  warning=FALSE, message=FALSE}
calc_annual_outside_normal(station_number = "08NM116", start_year = 1974)
```



```{r,  warning=FALSE, message=FALSE, fig.height = 4.5, fig.width = 7}
plot_annual_outside_normal(station_number = "08NM116", start_year = 1974) 
```
...
- `compute_full_analysis()` - calculate a suite of analyses from the fasstr functions
