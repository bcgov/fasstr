...
data <- as.data.frame(trends[[1]])[,1:4]
...
setting a zyp_alpha will plot a line if the significance value is equal or less than the alpha value.  TO plot a line through all of them, set eh value to 1. Example below witha alpha of 0.05
