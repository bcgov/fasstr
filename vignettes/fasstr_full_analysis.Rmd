...
3 - Annual	              |	Annual_Cumulative_Volume     	          | Table             | calc_annual_cumulative_stats(include_seasons=TRUE)
...
4 - Monthly	              |	Monthly_Cumulative_Volume     	          | Table             | calc_monthly_cumulative_stats()
...
5 - Daily	                |	Daily_Cumulative_Volume            	    | Table             | calc_daily_cumulative_stats()
5 - Daily	                |	Daily_Cumulative_Volume_with_Years	      | List / Folder with Plots | plot_daily_cumulative_stats(include_year)
